...
Dir[File.join(Rails.root, 'db', 'seeds', 'places_seeds.rb')].each do |seed|
  load seed
end
puts "...created #{Place.count} places."
puts
puts "Creating users..."
Dir[File.join(Rails.root, 'db', 'seeds', 'users_seeds.rb')].each do |seed|
  load seed
end
puts "...created #{User.count} users."
puts
puts "Creating reviews..."
Dir[File.join(Rails.root, 'db', 'seeds', 'reviews_seeds.rb')].each do |seed|
  load seed
end
puts "...created #{Review.count} reviews."
puts
puts "Creating itineraries..."
Dir[File.join(Rails.root, 'db', 'seeds', 'itineraries_seeds.rb')].each do |seed|
  load seed
end
puts "...created #{Itinerary.count} itineraries."
puts
puts "Creating destinations..."
Dir[File.join(Rails.root, 'db', 'seeds', 'destinations_seeds.rb')].each do |seed|
  load seed
end
